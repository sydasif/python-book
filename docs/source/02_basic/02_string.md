...
**Creating Columns:** You can format text into columns with f-strings by specifying a column width and alignment:
...
**Formatting Floats:** You can control the number of decimal places for floating-point numbers:
...
This will output: `My Var: 0.33`

**Date Formatting:** You can format dates using f-strings. For example, to format the current date:
...
This will output: `Date: October 22, 2023`

These features make f-strings a valuable tool for precise and flexible string formatting in Python.
